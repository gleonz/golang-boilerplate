...
func NewServerAPI(spec *loads.Document) *ServerAPI {
	return &ServerAPI{
		...
		UsuariosAgregarUsuarioHandler: usuarios.AgregarUsuarioHandlerFunc(func(params usuarios.AgregarUsuarioParams) middleware.Responder {
			return middleware.NotImplemented("operation usuarios.AgregarUsuario has not yet been implemented")
		}),
		UsuariosGetUsuarioPorIDHandler: usuarios.GetUsuarioPorIDHandlerFunc(func(params usuarios.GetUsuarioPorIDParams) middleware.Responder {
			return middleware.NotImplemented("operation usuarios.GetUsuarioPorID has not yet been implemented")
		}),
	}
}

/*ServerAPI API para gestionar usuarios */
type ServerAPI struct {
	...
	// UsuariosAgregarUsuarioHandler sets the operation handler for the agregar usuario operation
	UsuariosAgregarUsuarioHandler usuarios.AgregarUsuarioHandler
	// UsuariosGetUsuarioPorIDHandler sets the operation handler for the get usuario por Id operation
	UsuariosGetUsuarioPorIDHandler usuarios.GetUsuarioPorIDHandler
...
func (o *ServerAPI) Validate() error {
	...
	if o.UsuariosAgregarUsuarioHandler == nil {
		unregistered = append(unregistered, "usuarios.AgregarUsuarioHandler")
	}
	if o.UsuariosGetUsuarioPorIDHandler == nil {
		unregistered = append(unregistered, "usuarios.GetUsuarioPorIDHandler")
	}
...
func (o *ServerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/usuarios"] = usuarios.NewAgregarUsuario(o.context, o.UsuariosAgregarUsuarioHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/usuarios/{id}"] = usuarios.NewGetUsuarioPorID(o.context, o.UsuariosGetUsuarioPorIDHandler)
}
